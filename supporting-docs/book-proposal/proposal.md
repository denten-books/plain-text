...
rather structure imposed from without. The chapter makes extensive use of case
studies from the history of early twentieth century telegraphy, to illustrate
the concluding discussion on the nature of binary and plain text formats, in a
distinction that supersedes the dichotomy between analog and digital media.
...
concepts such as "text" and "code" up to second-order concepts such as "file,"
"folder," and "document." The chapter starts by developing a theory of
...
(and punch card) to a magnetic inscription (in the form of electrical charge)
invisible to the naked human eye. The case study unfolds the distinction
between print (in which matter, form, and content lie flat) and screen (where
the three layers occupy physically distinct media, providing only the illusion
of flattened textuality). The discussion concludes with a stark image, visually
illustrating the difference between plain text and binary formats. To produce
the image, I inject malicious code into an Adobe Acrobat file (`.pdf`), showing
the contrast between surface text and its underlying magnetically bound bit
structure.
...
McLuhan, I examine several related models of communication, including ones
proposed by semioticians (Charles Sanders Peirce, Ferdinand de Saussure, Roman
Jakobson), engineers (Harry Nyquist, Claude Shannon), and animal
anthropologists (Jakob von Uexküll, Gregory Bateson, and Thomas Sebok).
Corresponding to the mediating role of "form" in the previous chapters, I find
that the "mode" of the written communication act does something akin to
"attuning" the reader (receiver) to the encoding of the message (and to the
...
Works of Shakespeare*, Vivaria Press, 2002.) The possibility of a randomly
...
Building on the communication models described in the last chapter, I ask: What
is being externalized, communicated, and preserved?  And answer: It is not
...
good on the implied archeological metaphor: involving excavation, surveying,
and artifact discovery, at the level of the literal device.
...
audiences. The first comprises media history and theory scholars interested in
the history of data and computing in the twentieth century. The second audience
can be located in literary fields of study, among scholars seeking to
understand the impact of technology on literary theory and practice. Finally,
the book targets the broader audience of digital humanities and information
science practitioners (particularly in the field of human--computer
interaction), actively engaged in using and creating textual interfaces that
shape contemporary reading and writing praxis.
...
by Digital Humanities labs across the country and by my colleagues at the
Columbia University Department of English and at Harvard University's Berkman
Center for Internet & Society, where I am an active faculty associate. I keep
these manifold audiences in mind as I complete "Plain Text." The book exposes
intellectual frameworks that bolster my research and teaching activities. I
write to strengthen these projects and to give back to the community that has
supported me so generously. I hope to rely on the same good will and support
networks in reaching out to promote my book.
...
fundamentals of computer science in context. I hope for chapters of my book to
be useful in similar contexts. The (optional) technical appendix proposed in
the next section could serve to supplement the main body of the work with a
series of "experiments" that illustrate theoretical concepts in action, at the
keyboard. Such a blend of theory and practice defines my method.

## Length and Format

I am writing the book as a traditional volume, expounding a sustained thesis
across seven chapters (along with a short introduction). At this point, I am
aiming for a manuscript of around 80,000 words (not including citations),
allotting around 10,000 to 12,000 words per chapter.
...
encoded at the level of the operating system (Chapter 4). Similarly, the
...
Although not required for an understanding of the book, I would like to include
a supplementary technical appendix that expands on the theoretical insight from
...
could exist on paper (as a written appendix) or as a complementary website.
Training in computational methods often begins with packaged tools that obscure
...
understanding of the political issues around computation, be they "open
access," "freedom of information," or "online privacy," begin at that system
level. The book's technical appendix, although not required for an
